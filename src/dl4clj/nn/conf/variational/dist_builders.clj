...
(comment
  ;; new-composite-reconstruction-distribution example
  (new-composite-reconstruction-distribution
   :distributions-to-add {0 {:dist (distributions {:bernoulli {:activation-fn :relu}})
                             :dist-size 1}

                          1 {:bernoulli {:activation-fn :tanh
                                         :dist-size 5}}

                          2 {:bernoulli {:activation-fn :sigmoid
                                         :dist-size 3}}

                          3 {:bernoulli {:activation-fn :hard-tanh
                                         :dist-size 1}}
  ...
  (distributions
   {:composite {:distributions-to-add {0 {:dist (distributions {:bernoulli {:activation-fn :relu}})
                                          :dist-size 2}
