#_(ns ^{:doc "see https://github.com/deeplearning4j/dl4j-0.4-examples/blob/master/src/main/java/org/deeplearning4j/examples/paragraphvectors/tools/FileLabelAwareIterator.java"}
...
#_(defrecord FileLabelAwareIterator [docs position labels-source]
  LabelAwareIterator
...
#_(defn add-source-folder [builder folder]
...
#_(defn file-label-aware-iterator [& root-folders]
