(ns dl4clj.datasets.iterator.impl.move-window-data-set-fetcher
  (:import [org.deeplearning4j.datasets.iterator.impl MovingWindowDataSetFetcher]))

;;https://deeplearning4j.org/doc/org/deeplearning4j/datasets/iterator/impl/MovingWindowDataSetFetcher.html
;; Moving window data fetcher. Handles rotation of matrices in all directions to generate more examples.
